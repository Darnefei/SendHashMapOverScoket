 ...
 * Zudem sind hier die Methoden zu den Kn�pfen und zur sonstigen UI-Logic programmiert
 * Wichtige Methoden hierbei sind:
 *
 * SignIn() und SignUp() um einen Nutzer einzuloggen oder zu registrieren
 *
 * loadUI ( int , String )  ->  f�gt den Kalendertagen die zugeh�rigen Daten hinzu indem diese die
 ...
 *
 * Die meisten anderen Methoden sind zust�ndig, um mit den verschiedenen Monaten und Jahren zu interagieren.
 *
 *
 */
...
public class Controller {
	...
	private void addMeeting() {
		...
		if (hour.equals("") || min.equals("") || meetingNamen.equals("")) {
			errorLabel1.setText("Bitte alle Felder bef�llen");
